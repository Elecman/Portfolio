...
/******/{
  ...
  /***/function websiteSrcJsMainJs(module, exports) {

    document.addEventListener('DOMContentLoaded', function () {
      var ButtonToggle = document.getElementsByClassName('navbar-toggler');
      var ListToggle = document.getElementsByClassName('dropdown-toggle');

      var DropDownMenu = function DropDownMenu() {
        var _loop = function _loop(i) {
          console.log(ButtonToggle[i]);
          ButtonToggle[i].addEventListener('click', function () {
            var DropDownContainer = ButtonToggle[i].nextElementSibling;
      ...
      var DropDownList = function DropDownList() {
        var _loop2 = function _loop2(i) {
          ...
          ListToggle[i].addEventListener('click', function () {
            var ListDropWrapper = ListToggle[i].nextElementSibling;
